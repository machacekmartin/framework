...
function Vn() {
    !$e && !Ie && ((Ie = !0), queueMicrotask(Yn));
}
function Yn() {
    (Ie = !1), ($e = !0);
    for (let e = 0; e < N.length; e++) N[e](), (Pe = e);
    (N.length = 0), (Pe = -1), ($e = !1);
}
var q,
    B,
...
function Je(e, t) {
    typeof t == 'function' ? (e._x_cleanups || (e._x_cleanups = []), e._x_cleanups.push(t)) : ((t = e), Pt.push(t));
}
function jt(e) {
    $t.push(e);
}
...
function er(e) {
    for (e._x_effects?.forEach(Jn); e._x_cleanups?.length; ) e._x_cleanups.pop()();
}
var Ve = new MutationObserver(Ze),
    Ye = !1;
function Ge() {
    Ve.observe(document, { subtree: !0, childList: !0, attributes: !0, attributeOldValue: !0 }), (Ye = !0);
}
function Ft() {
    tr(), Ve.disconnect(), (Ye = !1);
}
var G = [];
function tr() {
    let e = Ve.takeRecords();
    G.push(() => e.length > 0 && Ze(e));
    let t = G.length;
    queueMicrotask(() => {
...
function Ze(e) {
    ...
    for (let o of n) t.some((s) => s.contains(o)) || Pt.forEach((s) => s(o));
    for (let o of t) o.isConnected && Rt.forEach((s) => s(o));
...
var ir = {
    ...
    get({ objects: e }, t, n) {
        return t == 'toJSON' ? or : Reflect.get(e.find((r) => Reflect.has(r, t)) || {}, t, n);
    },
    set({ objects: e }, t, n, r) {
...
function je(e, t, n) {
    if ((typeof t == 'string' && (t = t.split('.')), t.length === 1)) e[t[0]] = n;
        ...
        return e[t[0]] || (e[t[0]] = {}), je(e[t[0]], t.slice(1), n);
    }
}
var Kt = {};
function A(e, t) {
...
function he(e, t, n, r, i) {
    if (de && typeof t == 'function') {
        let o = t.apply(n, r);
        o instanceof Promise ? o.then((s) => he(e, s, n, r)).catch((s) => ne(s, i, t)) : e(o);
...
function Jt(e) {
    ...
    return (
        t.push(i),
        [
            { Alpine: oe, effect: r, cleanup: n, evaluateLater: m.bind(m, e), evaluate: L.bind(L, e) },
            () => t.forEach((a) => a()),
        ]
    );
}
function gr(e, t) {
    ...
    let s = () => {
        e._x_ignore ||
            e._x_ignoreSelf ||
            (r.inline && r.inline(e, t, i), (r = r.bind(r, e, t, i)), Le ? Q.get(Ut).push(r) : r());
    };
...
function Gt(e = () => {}) {
    return ({ name: t, value: n }) => {
        let { name: r, value: i } = Xt.reduce((o, s) => s(o), { name: t, value: n });
...
function vr() {
    ...
    Array.from(document.querySelectorAll(nn().join(',')))
        .filter(e)
        .forEach((t) => {
            C(t);
        }),
...
function ye(e, t = !1) {
    return J(e, (n) => {
        if ((t ? nn() : tn()).some((i) => n.matches(i))) return !0;
    });
}
function J(e, t) {
    if (e) {
...
function ve(e, t) {
    return typeof t == 'object' && t !== null ? Or(e, t) : Cr(e, t);
}
function Or(e, t) {
    let n = {};
    return (
...
y('transition', (e, { value: t, modifiers: n, expression: r }, { evaluate: i }) => {
    typeof r == 'function' && (r = i(r)), r !== !1 && (!r || typeof r == 'boolean' ? Ir(e, n, t) : Tr(e, r, t));
});
function Tr(e, t, n) {
    an(e, ot, ''),
        {
...
function an(e, t, n = {}) {
    e._x_transition ||
        (e._x_transition = {
            ...
            in(r = () => {}, i = () => {}) {
                Ke(e, t, { during: this.enter.during, start: this.enter.start, end: this.enter.end }, r, i);
            },
            out(r = () => {}, i = () => {}) {
                Ke(e, t, { during: this.leave.during, start: this.leave.start, end: this.leave.end }, r, i);
            },
        });
}
    ...
    (e._x_hidePromise = e._x_transition
        ...
        queueMicrotask(() => {
            ...
            s
                ...
                : i(() => {
                      let a = (u) => {
                          let c = Promise.all([u._x_hidePromise, ...(u._x_hideChildren || []).map(a)]).then(([l]) =>
                              l?.()
                          );
...
function Ke(e, t, { during: n, start: r, end: i } = {}, o = () => {}, s = () => {}) {
    if (
...
function fn(e, t, n, r = []) {
    switch (
        (e._x_bindings || (e._x_bindings = q({})), (e._x_bindings[t] = n), (t = r.includes('camel') ? Hr(t) : t), t)
    ) {
        case 'value':
            Lr(e, n);
            break;
...
function Lr(e, t) {
    if (hn(e))
        e.attributes.value === void 0 && (e.value = t),
            window.fromModel &&
                (typeof t == 'boolean' ? (e.checked = pe(e.value) === t) : (e.checked = yt(e.value, t)));
    else if (st(e))
        Number.isInteger(t)
            ? (e.value = t)
...
function dn(e, t, n) {
    [null, void 0, !1].includes(n) && Wr(t) ? e.removeAttribute(t) : (pn(t) && (n = t), Br(e, t, n));
}
function Br(e, t, n) {
...
function Jr(e, t, n, r = !0) {
    ...
    if (e._x_inlineBindings && e._x_inlineBindings[t] !== void 0) {
        ...
        return (i.extract = r), zt(() => L(e, i.expression));
    }
    return _n(e, t, n);
}
function _n(e, t, n) {
...
var R = {},
    vt = !1;
function Yr(e, t) {
    if ((vt || ((R = q(R)), (vt = !0)), t === void 0)) return R[e];
    (R[e] = t),
        Dt(R[e]),
        typeof t == 'object' && t !== null && t.hasOwnProperty('init') && typeof t.init == 'function' && R[e].init();
}
function Gr() {
    return R;
}
...
function Xr(e, t) {
    ...
    return e instanceof Element ? bn(e, n()) : ((vn[e] = n), () => {});
}
function Zr(e) {
    return (
...
var ri = Object.freeze({}),
    ...
    wn = (e) => si.call(e),
    En = (e) => wn(e).slice(8, -1),
    ut = (e) => oi(e) && e !== 'NaN' && e[0] !== '-' && '' + parseInt(e, 10) === e,
    ai = (e) => {
...
function pi(e, t) {
    const n = function () {
        ...
        if (!Z.includes(n)) {
            An(n);
            try {
                return hi(), Z.push(n), (O = n), e();
            } finally {
                Z.pop(), On(), (O = Z[Z.length - 1]);
            }
        }
    };
    return (
...
function $(e, t, n, r, i, o) {
    ...
    if (t === 'clear') s.forEach(u);
        ...
        switch ((n !== void 0 && u(s.get(n)), t)) {
            case 'add':
                F(e) ? ut(n) && u(s.get('length')) : (u(s.get(k)), te(e) && u(s.get(qe)));
                break;
            case 'delete':
                F(e) || (u(s.get(k)), te(e) && u(s.get(qe)));
                break;
            case 'set':
                te(e) && u(s.get(k));
                break;
...
function Mn(e = !1, t = !1) {
    return function (r, i, o) {
        ...
        if (i === '__v_raw' && o === (e ? (t ? Ri : Pn) : t ? Pi : $n).get(r)) return r;
        const s = F(r);
        if (!e && s && me(bt, i)) return Reflect.get(bt, i, o);
        const a = Reflect.get(r, i, o);
        return (at(i) ? Cn.has(i) : gi(i)) || (e || S(r, 'get', i), t)
            ? a
            : We(a)
            ? !s || !ut(i)
                ? a.value
...
function mi(e = !1) {
    return function (n, r, i, o) {
        let s = n[r];
        if (!e && ((i = _(i)), (s = _(s)), !F(n) && We(s) && !We(i))) return (s.value = i), !0;
        const a = F(n) && ut(r) ? Number(r) < n.length : me(n, r),
            u = Reflect.set(n, r, i, o);
        return n === _(o) && (a ? Sn(i, s) && $(n, 'set', r, i, s) : $(n, 'add', r, i)), u;
    };
}
function wi(e, t) {
    const n = me(e, t),
...
function Ei(e, t) {
    ...
    return (!at(t) || !Cn.has(t)) && S(e, 'has', t), n;
}
function Si(e) {
    return S(e, 'iterate', F(e) ? 'length' : k), Reflect.ownKeys(e);
}
var Ai = { get: xi, set: bi, deleteProperty: wi, has: Ei, ownKeys: Si },
    Oi = {
        get: yi,
        set(e, t) {
...
function ce(e, t = !1) {
    return (e = e.__v_raw), !t && S(_(e), 'iterate', k), Reflect.get(e, 'size', e);
}
function mt(e) {
    e = _(e);
    const t = _(this);
    return Ee(t).has.call(t, e) || (t.add(e), $(t, 'add', e, e)), this;
}
function wt(e, t) {
    t = _(t);
    const n = _(this),
        { has: r, get: i } = Ee(n);
    let o = r.call(n, e);
    o ? In(n, r, e) : ((e = _(e)), (o = r.call(n, e)));
    const s = i.call(n, e);
    return n.set(e, t), o ? Sn(t, s) && $(n, 'set', e, t, s) : $(n, 'add', e, t), this;
}
function Et(e) {
    const t = _(this),
        { has: n, get: r } = Ee(t);
    let i = n.call(t, e);
    i ? In(t, n, e) : ((e = _(e)), (i = n.call(t, e)));
...
function le(e, t) {
    return function (r, i) {
        const o = this,
            ...
            a = _(s),
            u = t ? dt : e ? ft : lt;
        return !e && S(a, 'iterate', k), s.forEach((c, l) => r.call(i, u(c), u(l), o));
    };
}
function fe(e, t, n) {
    return function (...r) {
    ...
    return function (...t) {
        {
            ...
            console.warn(`${ui(e)} operation ${n}failed: target is readonly.`, _(this));
        }
...
function Ni(e) {
    return e.__v_skip || !Object.isExtensible(e) ? 0 : ji(En(e));
}
function pt(e) {
    return e && e.__v_isReadonly ? e : jn(e, !1, Ai, Ii, $n);
}
function Rn(e) {
    return jn(e, !0, Oi, $i, Pn);
}
...
A('data', (e) => kt(e));
A('root', (e) => ye(e));
A('refs', (e) => (e._x_refs_proxy || (e._x_refs_proxy = ie(Li(e))), e._x_refs_proxy));
function Li(e) {
    let t = [];
    return (
        J(e, (n) => {
...
function Ln(e, t, n) {
    A(t, (r) =>
        E(`You can't use [$${t}] without first installing the "${e}" plugin here: https://alpinejs.dev/plugins/${n}`, r)
    );
}
...
var Fn = () => {};
Fn.inline = (e, { modifiers: t }, { cleanup: n }) => {
...
y('model', (e, { modifiers: t, expression: n }, { effect: r, cleanup: i }) => {
    ...
    let u = () => {
            let p;
            return s((v) => (p = v)), Ct(p) ? p.get() : p;
        },
        c = (p) => {
            let v;
            s((M) => (v = M)), Ct(v) ? v.set(p) : a(() => {}, { scope: { __placeholder: p } });
        };
    typeof n == 'string' &&
        e.type === 'radio' &&
        g(() => {
    ...
    if (
        ...
        let p = Ue(e.form, 'reset', [], (v) => {
            it(() => e._x_model && e._x_model.set(Me(e, t, { target: e }, u())));
        });
        i(() => p());
    }
    (e._x_model = {
    ...
    return g(() => {
        ...
        if (st(e))
            if (Array.isArray(r)) {
                ...
                return (
                    t.includes('number')
                        ...
                        ? (i = pe(n.target.value))
                        : (i = n.target.value),
                    n.target.checked ? (r.includes(i) ? r : r.concat([i])) : r.filter((o) => !Ui(o, i))
                );
                    ...
                    : Array.from(n.target.selectedOptions).map((i) => i.value || i.text);
            {
                let i;
                return (
                    hn(e) ? (n.target.checked ? (i = n.target.value) : (i = r)) : (i = n.target.value),
                    t.includes('number') ? Te(i) : t.includes('boolean') ? pe(i) : t.includes('trim') ? i.trim() : i
                );
            }
        }
    });
...
y(
    'init',
    P((e, { expression: t }, { evaluate: n }) => (typeof t == 'string' ? !!t.trim() && n(t, {}, !1) : n(t, {}, !1)))
);
...
tt(Vt(':', Yt(U('bind:'))));
var Dn = (e, { value: t, modifiers: n, expression: r, original: i }, { effect: o, cleanup: s }) => {
    if (!t) {
        let u = {};
        Zr(u),
            m(e, r)(
    ...
    o(() =>
        a((u) => {
            u === void 0 && typeof r == 'string' && r.match(/\./) && (u = ''), g(() => fn(e, t, u, n));
        })
    ),
        s(() => {
...
Dn.inline = (e, { value: t, modifiers: n, expression: r }) => {
    ...
    n((s) => {
        ...
        for (let f = 0; f < d.length; f++) {
            ...
            re(Y, _t, o),
                ...
                typeof K == 'object' && E('x-for key cannot be an object, it must be a string or an integer', o),
                (a[K] = Y);
        }
...
oe.setEvaluator(qt);
oe.setReactivityEngine({ reactive: pt, effect: li, release: fi, raw: _ });
var Qi = oe,
    Kn = Qi;
window.Alpine = Kn;
Kn.start();
